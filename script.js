...
function showResult() {
  ...
  let descriptions = {
    Red: "Leader 🔴 - You are confident, determined, and enjoy taking charge.",
    Orange: "Socializer 🟠 - You are outgoing, energetic, and love being around people.",
    Yellow: "Optimist 🟡 - You are cheerful, positive, and bring happiness to others.",
    Green: "Helper 🟢 - You are caring, supportive, and value harmony.",
    Blue: "Thinker 🔵 - You are logical, analytical, and enjoy solving problems.",
    Indigo: "Intuitive 🟣 - You are reflective, thoughtful, and deeply intuitive.",
